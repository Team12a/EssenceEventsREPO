  ...
  .controller('CorporateCtrl', ['TextEdit', '$scope', '$stateParams', '$state', function (TextEdit, $scope, $stateParams, $state) {
    ...
    $scope.getText1 = function(){
      var text_id= 'corporateDescriptText';
      // console.log('Here');
    ...
    $scope.getText2 = function(){
      var text_id= 'corporateTestimonial';
      // console.log('Here');
      TextEdit.getByID(text_id)
        .then(function(response) {
    ...
    $scope.getText3 = function(){
      var text_id='corporateTestimonialAuthor';
      // console.log('Here');
      TextEdit.getByID(text_id)
        .then(function(response) {

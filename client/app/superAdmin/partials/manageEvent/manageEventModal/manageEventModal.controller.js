...
.controller('ManageEventModalCtrlSuper', ['$scope', '$state', '$q', '$modalInstance', 'event', 'Events', 'Subcontractors', 'uiGmapGoogleMapApi', function ($scope, $state, $q, $modalInstance, event, Events, Subcontractors, uiGmapGoogleMapApi)
{
